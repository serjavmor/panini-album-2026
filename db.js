// Base de datos del Álbum Panini Mundial 2026 (Generada del PDF Real)
// Contiene 48 equipos (12 grupos de 4) y la sección especial "FWC" con 20 stickers por selección.

export const SPECIAL_SECTION = {
  id: "FWC",
  name: "FIFA World Cup",
  stickers: [
    { id: "FWC-01", name: "Logo Oficial Panini" },
    { id: "FWC-02", name: "Trofeo del Mundial 2026" },
    { id: "FWC-03", name: "Mascota Oficial" },
    { id: "FWC-04", name: "Estadio Azteca (CDMX)" },
    { id: "FWC-05", name: "MetLife Stadium (NY/NJ)" },
    { id: "FWC-06", name: "SoFi Stadium (Los Angeles)" },
    { id: "FWC-07", name: "Mercedes-Benz Stadium (Atlanta)" },
    { id: "FWC-08", name: "Hard Rock Stadium (Miami)" },
    { id: "FWC-09", name: "BC Place (Vancouver)" },
    { id: "FWC-10", name: "Estadio BBVA (Monterrey)" },
    { id: "FWC-11", name: "Estadio Akron (Guadalajara)" },
    { id: "FWC-12", name: "Gillette Stadium (Boston)" },
    { id: "FWC-13", name: "AT&T Stadium (Dallas)" },
    { id: "FWC-14", name: "NRG Stadium (Houston)" },
    { id: "FWC-15", name: "Arrowhead Stadium (Kansas City)" },
    { id: "FWC-16", name: "Lincoln Financial Field (Philadelphia)" },
    { id: "FWC-17", name: "Lumen Field (Seattle)" },
    { id: "FWC-18", name: "Poster Oficial 2026" }
  ]
};
...
const REAL_ROSTERS_DB = {
  ...
  "QAT": {
    ...
    "stickers": [
      ...
      {
        "id": "QAT-11",
        "name": "Assim Madibo Hamed",
        "number": 11
      },
      {
        "id": "QAT-12",
        "name": "Alganehi Almoez",
        "number": 12
      },
      {
        "id": "QAT-13",
  ...
  "MAR": {
    ...
    "stickers": [
      ...
      {
        "id": "MAR-19",
        "name": "Khannouss Ismael",
        "number": 19
      },
      {
        "id": "MAR-20",
        "name": "Saibari Youssef",
        "number": 20
      }
    ]
  },
  "HAI": {
    ...
    "stickers": [
      ...
      {
        "id": "HAI-16",
        "name": "Christopher Attvs",
        "number": 16
      },
      {
        "id": "HAI-17",
        "name": "Deedson Frantzdy",
        "number": 17
      },
      {
        "id": "HAI-18",
  ...
  "SWE": {
    ...
    "stickers": [
      ...
      {
        "id": "SWE-05",
        "name": "Viktor Johansson Swe",
        "number": 5
      },
      {
        "id": "SWE-06",
        "name": "Victor Nilsson Lindelf",
        "number": 6
      },
      {
        "id": "SWE-07",
  ...
  "BEL": {
    ...
    "stickers": [
      ...
      {
        "id": "BEL-04",
        "name": "Tielemans Amadou Onana",
        "number": 4
      },
      {
        "id": "BEL-05",
        "name": "Maxim De Cuvper",
        "number": 5
      },
      {
        "id": "BEL-06",
        "name": "Raskin Saelemaekers",
        "number": 6
      },
      {
        "id": "BEL-07",
  ...
  "KSA": {
    ...
    "stickers": [
      ...
      {
        "id": "KSA-09",
        "name": "Chn Zivad Aljohani",
        "number": 9
      },
      {
        "id": "KSA-10",
        "name": "Jordan Saudi Arabi",
        "number": 10
      },
      {
        "id": "KSA-11",
  ...
  "NOR": {
    ...
    "stickers": [
      ...
      {
        "id": "NOR-11",
        "name": "Berge Schjelderup",
        "number": 11
      },
      {
        "id": "NOR-12",
        "name": "Sloth Aron Dnnum",
        "number": 12
      },
      {
        "id": "NOR-13",
  ...
  "JOR": {
    ...
    "stickers": [
      ...
      {
        "id": "JOR-15",
        "name": "Mohammad Abu Zravo",
        "number": 15
      },
      {
        "id": "JOR-16",
        "name": "Altaamari Yazan",
        "number": 16
      },
      {
        "id": "JOR-17",
  ...
  "UZB": {
    ...
    "stickers": [
      ...
      {
        "id": "UZB-09",
        "name": "Kyrgyz Republicuzbekistan",
        "number": 9
      },
      {
        "id": "UZB-10",
  ...
  "COL": {
    ...
    "stickers": [
      ...
      {
        "id": "COL-10",
        "name": "Bolivia Colomeia",
        "number": 10
      },
      {
        "id": "COL-11",
        "name": "Kevin Castaño Richard",
        "number": 11
      },
      {
        "id": "COL-12",
  ...
  "ENG": {
    ...
    "stickers": [
      ...
      {
        "id": "ENG-03",
        "name": "John Stones Guéhi",
        "number": 3
      },
      {
        "id": "ENG-04",
        "name": "Eno Jordan Pickford",
        "number": 4
      },
      {
        "id": "ENG-05",
  ...
  "PAN": {
    ...
    "stickers": [
      ...
      {
        "id": "PAN-11",
        "name": "Anibal Godov Carrasquilla",
        "number": 11
      },
      {
        "id": "PAN-12",
...
export const getAlbumDatabase = () => {
  ...
  // 2. Procesar cada Selección inyectando sus stickers reales
  TEAMS_DATA.forEach(team => {
    const data = REAL_ROSTERS_DB[team.id];
    if (data) {
      database[team.id] = {
        id: team.id,
        name: team.name,
